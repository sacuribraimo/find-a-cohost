...
import { Podcast, Eye, EyeOff } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2">
            <div className="bg-gradient-to-r from-purple-600 to-purple-800 w-12 h-12 rounded-lg flex items-center justify-center" style={{background: '#663090'}}>
              <Podcast className="w-7 h-7 text-white" />
            </div>
            <span className="text-2xl font-bold text-gray-900">FindACoHost</span>
          </Link>
        </div>
